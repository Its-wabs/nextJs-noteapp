        ...
        role="button"
         ...
         className={cn("group min-h-[27px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium",
          ...
          >
            ...
            <i  className="ri-sticky-note-add-line cursor-pointer m-1 p-1 text-lg rounded hover:bg-secondary items-center justify-center align-middle"></i>
            ...
            {isSearch && (
                ...
                rounded border bg-muted px-1.5 font-mono text-[10px] font-medium texxt-muted-foreground opacity-100">
